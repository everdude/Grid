<ul>
    ...
    <li class="level_1<?php if($uri_segments[1] == "graphic-design"){?> active<?php }?>"><a href="graphic-design">Graphic Design</a></li>
    <li class="level_1<?php if($uri_segments[1] == "fine-art-gallery"){?> active<?php }?>"><a href="/fine-art-gallery">Fine Art Gallery</a></li>
    <li class="level_1<?php if($uri_segments[1] == "articles"){?> active<?php }?>"><a href="/articles">Articles</a></li>
    <li class="level_1<?php if($uri_segments[1] == "resume"){?> active<?php }?>"><a href="/resume">Resume</a></li>
